...
public class Main {
    ...
    public static int countDig(int number){ // that method find the length of current row/columns number
        int count = 0;
        if (number==0) {
            return 1;
        }
    ...
    public static void printBoard(int n, int m, int rowLenght, int columnsLength, String[][] String) {
